...
sasayaka プロジェクトにおける人格要約の品質改善のため、SHIORI 言語（YAYA / Satori / Kawari）で記述された会話スクリプトの構造を俯瞰的に把握し、分岐・遷移のパターンを視覚的に分析できる環境を提供する。
...
- **理由**: サーバーレスで運用コストゼロ。sasayaka プロジェクトと同じ GitHub オーガニゼーション内で管理できる
